...
store.dispatch(addMovie({ description: 'Kill Bill', price: 4500 }));
store.dispatch(addMovie({ description: 'The Room', price: 1000 }));
store.dispatch(addMovie({ description: 'Kill Bill 2', price: 5000 }));

const aMovie = store.dispatch(addMovie({ description: 'Remove Movie', price: 5500 }));
